...
public class LockboxManager4 : MonoBehaviour
{
    ...
    [SerializeField] private LockboxNumber number4;
    ...
    private void checkNumbers()
    {
        ...
        string inputSequence = number1.Number.ToString() + number2.Number.ToString() + number3.Number.ToString() + number4.Number.ToString();
